            ...
            <nav id="nav-bar">
                <ul>
                    { currentVariant === 'mobile' && 
                        <>
                            { showMobileMenu ? 
                                <li onClick={ () => setShowMobileMenu((v) => !v)}><img id="hamburger-menu-cross" src="/cross.svg" alt="Cross Icon"/></li>
                            :
                                <li onClick={ () => {
                                    if(showSearchBar) setShowSearchBar(false)
                    ...
                    <li><Link to='/'><img id="logo-header" src="/logo.svg" alt="Logo" /></Link></li>

                    { currentVariant === 'mobile' && 
                        <li id="active-link-mobile"><p>{activeLinkMobile}</p></li>
                    }
                ...
                { (currentVariant === 'desktop' || (currentVariant === 'mobile' && showMobileMenu ) ) && 
                    <ul id="nav-bar-menu">
                        <li><NavLink to='/divertissement'>Divertissement</NavLink></li>
                        <li><NavLink to='/entreprise'>Entreprise</NavLink></li>
                        <li><NavLink to='/politique'>Politique</NavLink></li>
                        <li><NavLink to='/sante'>Santé</NavLink></li>
                        <li><NavLink to='/science'>Science</NavLink></li>
                        <li><NavLink to='/sports'>Sports</NavLink></li>
                        <li><NavLink to='/technologie'>Technologie</NavLink></li>
                    </ul>
                }
